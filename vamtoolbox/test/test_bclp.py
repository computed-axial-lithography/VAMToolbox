...
optimizer_params = vam.optimize.Options(method='BCLP',n_iter=50, filter='ram-lak_freq',verbose='plot', p=2, learning_rate = 1.2, response_model = "default", eps=0.1) #Working
...
# optimizer_params = vam.optimize.Options(method='BCLP',n_iter=50, filter='ram-lak_freq',verbose='plot', p=10, learning_rate = 0.25, response_model = "default", eps=0.05) #Works
