...
target_geo = vam.geometry.TargetGeometry(imagefilename=vam.resources.load("reschart.png"),pixels=512)
# target_geo.show()
...
ax.imshow(g0, vmin = np.amin(f), vmax = np.amax(f))
...
#Second test: Forward project only 1 voxel having a value of 1, and 0 otherwise.
#Results showed that the projector is perserving the value of 1 in corresponding sinogram pixel.