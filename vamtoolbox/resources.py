...
def load(input:str):
    ...
    ----------
    input : str
        resource to load, options: "reschart.png", "trifurcatedvasculature.stl", "bear.stl", "thinker.stl", "screwdriver.stl", "cylinder.stl", "seq0imagesdir", "sino0.sino", "video0.mp4",
