...
Finally, show the target with the :py:meth:`VAMToolbox.geometry.Volume.show` method and use the ``show_insert`` kwarg to show the insert bodies in a red color.
