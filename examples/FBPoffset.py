if __name__ == "__main__":
    ...
    # FBP
    optimizer_params = vam.optimize.Options(method='FBP',filter='shepp-logan',verbose=None)
    opt_sino, opt_recon, error = vam.optimize.optimize(target_geo, proj_geo,optimizer_params)
    opt_recon.show()

    # FBP with offset
    optimizer_params = vam.optimize.Options(method='FBP',filter='shepp-logan',offset=True,verbose=None)
    opt_sino, opt_recon, error = vam.optimize.optimize(target_geo, proj_geo,optimizer_params)
    opt_recon.show()
