...
optimizer_params = vam.optimize.Options(method='BCLP',n_iter=30, filter='ram-lak',verbose='plot', p=2, learning_rate = 0.00001, response_model = response_model, eps=0.1)
