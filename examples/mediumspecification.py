...
index_model = vam.medium.IndexModel(coord_vec, type = 'interpolation', form='homogeneous', n_sur=1.5)
index_model.plotIndex(block=False)
index_model = vam.medium.IndexModel(coord_vec, type = 'interpolation', form='luneburg_lens', R=1.2, length_unit_of_R='fractional_domain_radius')
index_model.plotIndex(block=False)

attenuation_model = vam.medium.AttenuationModel(coord_vec, type = 'analytical', form='homogeneous_cylinder', R = 1, alpha_internal = 0.2)
